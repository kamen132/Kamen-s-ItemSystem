...
{
    public partial class HeroCardCell : UIItem
    {
        public override string AssetPath {get;protected set;} = @"Assets/Resources_moved/Game/UI/ItemSystem/HeroCardCell.prefab";
        public override string Name {get;protected set;} = @"HeroCardCell";
        public string PrefabAssetPath {get;protected set;} = @"Assets/Resources_moved/Game/UI/ItemSystem/HeroCardCell.prefab";
...
#region Custom Control defines 
        ...
        /// </summary>
        public HeroCardCell(GameObject root)
        {
            this.Root = root;
            this.Initialize();
        }
