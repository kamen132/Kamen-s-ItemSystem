...
namespace Game.UI.Code
{
    ...
    {
        public override string AssetPath {get;protected set;} = @"Assets/Resources_moved/Game/UI/UITestView.prefab";
        public override string Name {get;protected set;} = @"UITestView";
        public string PrefabAssetPath {get;protected set;} = @"Assets/Resources_moved/Game/UI/UITestView.prefab";
