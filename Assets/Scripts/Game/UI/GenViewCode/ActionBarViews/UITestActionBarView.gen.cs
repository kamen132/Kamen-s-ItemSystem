...
{
    public partial class UITestActionBarView : UIActionBarBaseView
    {
        public override string AssetPath {get;protected set;} = @"Assets/Resources_moved/Game/UI/UITestActionBarView.prefab";
        public override string Name {get;protected set;} = @"UITestActionBarView";
        public string PrefabAssetPath {get;protected set;} = @"Assets/Resources_moved/Game/UI/UITestActionBarView.prefab";
