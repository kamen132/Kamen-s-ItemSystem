...
{
    public partial class UITestActionBarViewB : UIActionBarBaseView
    {
        public override string AssetPath {get;protected set;} = @"Assets/Resources_moved/Game/UI/UITestActionBarViewB.prefab";
        public override string Name {get;protected set;} = @"UITestActionBarViewB";
        public string PrefabAssetPath {get;protected set;} = @"Assets/Resources_moved/Game/UI/UITestActionBarViewB.prefab";
